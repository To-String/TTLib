...
#ifndef TT_STACK_H
#define TT_STACK_H
/// 注意:因为宏没有命名空间，所以你的宏全部添加前缀TT_
#define TT_OK 1
#define TT_ERROR 0


namespace tt 
{ /// 注意: 添加命名空间(你所有实现的库都应该在你自己的命名空间中)
	...
	public:
		...
		~Stack();
		/// 注意: stackFull前面可以不需要stack直接为isFull就可以了,其他的destroyStack,clearStack,stackEmepty类似，因为这些成员函数是在'stack'这个上下文下的
		/// 所以不用添加stack前缀或后缀
